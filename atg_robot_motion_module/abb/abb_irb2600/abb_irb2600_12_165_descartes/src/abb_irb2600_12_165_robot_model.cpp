...
using namespace irb2600_12_165_ikfast_manipulator_plugin;

namespace abb_irb2600_12_165_descartes
{
...
bool AbbIrb2600RobotModel::initialize(const std::string& robot_description,
                                      ...
                                      const std::string& tcp_frame)
{
  ...
  irb2600_12_165_ikfast_manipulator_plugin::IKFastKinematicsPlugin::initialize(
                                    ...
                                    std::vector<std::vector<double> >& joint_poses) const
{
  ...
  ikfast_irb2600::IkSolutionList<IkReal> solutions;
...
PLUGINLIB_EXPORT_CLASS(abb_irb2600_12_165_descartes::AbbIrb2600RobotModel, descartes_core::RobotModel)
