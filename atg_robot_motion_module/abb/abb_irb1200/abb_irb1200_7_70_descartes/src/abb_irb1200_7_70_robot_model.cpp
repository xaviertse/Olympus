...
using namespace abb_irb1200_7_70_ikfast_manipulator_plugin;

namespace abb_irb1200_7_70_descartes
{
AbbIrb1200RobotModel::AbbIrb1200RobotModel()
    : world_to_base_(Eigen::Affine3d::Identity()), tool_to_tip_(Eigen::Affine3d::Identity())
{
}

bool AbbIrb1200RobotModel::initialize(const std::string& robot_description,
                                      ...
                                      const std::string& tcp_frame)
{
  ...
  abb_irb1200_7_70_ikfast_manipulator_plugin::IKFastKinematicsPlugin::initialize(
...
bool AbbIrb1200RobotModel::getAllIK(const Eigen::Affine3d& pose,
                                    std::vector<std::vector<double> >& joint_poses) const
{
  ...
  ikfast_irb1200::IkSolutionList<IkReal> solutions;
...
PLUGINLIB_EXPORT_CLASS(abb_irb1200_7_70_descartes::AbbIrb1200RobotModel, descartes_core::RobotModel)
