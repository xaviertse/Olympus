...
#include <atg_ur10e_descartes/ikfast.h>
using namespace ikfast_ur10e;
...
IKFAST_API bool ComputeIk(const IkReal* eetrans, const IkReal* eerot, const IkReal* pfree, IkSolutionListBase<IkReal>& solutions) {
  ...
  int num_sols = ur10e_ur_kinematics::inverse(T, q_sols,pfree[0]);
...
{
    double T[16];
    ur10e_ur_kinematics::forward(j,T);
