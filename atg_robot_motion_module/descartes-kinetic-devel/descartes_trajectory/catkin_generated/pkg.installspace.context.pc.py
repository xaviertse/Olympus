...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/usr/local/include;/usr/include;/usr/local/include/eigen3".split(';') if "/usr/local/include;/usr/include;/usr/local/include/eigen3" != "" else []
